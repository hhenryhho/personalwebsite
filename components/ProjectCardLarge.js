...
import { Flex, Stack, Box, Heading, Text, Link } from '@chakra-ui/layout'
    ...
    <Flex flexDir="row">
      ...
      <Box position="relative" w="100%">
        ...
        <Box position="absolute" top={10} w={500}>
          <Box position="absolute" w="315px" top={120} left={150}>
            <Stack>
              <Text color="brand.100">{project.description}</Text>
